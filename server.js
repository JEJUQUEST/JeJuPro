...
/**
 * [해결 #1] 'Cannot GET /' 및 'PathError' 해결
 * 모든 요청에 대해 public/index.html을 반환하여 SPA 라우팅을 활성화합니다.
 * Express PathError를 피하기 위해 와일드카드를 '*' 대신 '/*'로 사용합니다.
 */
app.get('/*', (req, res) => {
...
/**
 * [해결 #2] Render 포트 바인딩 및 리스닝
 * Render의 PORT 환경 변수를 사용하고, 외부 접속을 위해 '0.0.0.0' 호스트에 바인딩합니다.
 */
